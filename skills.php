			...
			<h1>Technical Skills</h1>
			 	...
			 	<table>
			 		...
			 		<?php 
						...
						while($s = mysqli_fetch_assoc($query1)){
							echo "<tr><td>".$s['correlativo'].
								 "</td><td>".$s['titulo'].
								 "</td><td>".$s['porcentaje'].'%'.
								 "</td>

								 <td><a href='deleteSkill.php?skills=".$s['correlativo']."'><i class='fas fa-trash-alt'></i></a></td>

								<td><a href='final_updateSkills.php?skills=".$s['correlativo']."&titulo=".$s['titulo']."&porcentaje=".$s['porcentaje']."'><i class='fas fa-edit'></i></a></td></tr>";
						}
